...
public class MortgagePayoffCalcFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("For use with known remaining loan term:");

        jLabel3.setText("For use with unknown remaining loan term:");

        jLabel4.setText("Principal Amount ($):");

        jLabel5.setText("Original Term (yrs):");

        jLabel6.setText("Interest Rate (%):");

        jLabel7.setText("Remaining Term (yrs):");

        jLabel8.setText("Principal Amount ($):");

        jLabel9.setText("Monthly Payment ($):");

        jLabel10.setText("Interest Rate (%):");

        jLabel11.setText("Repayment Options:");

        jLabel12.setText("Repayment Options:");
        ...
        jLabel13.setText("$ per month:");

        jLabel14.setText("$ per year:");

        jLabel15.setText("one time ($):");
        ...
        jLabel16.setText("$ per month:");

        jLabel17.setText("$ per year:");

        jLabel18.setText("one time ($):");
