 ...
 * @author Gabri
 */
public class buyvsrent extends javax.swing.JFrame {
...
try {
    ...
    homePrice = Double.parseDouble(jTextField1.getText());
        ...
        String taxFilingStatus = jTextField22.getText(); // Assuming a dropdown or simple text field
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buyvsrent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
