...
public class MonthlyLoanCalcFrame extends javax.swing.JFrame {

    public MonthlyLoanCalcFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Monthly Payment Amount ($):");
...
//<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonthlyLoanCalcFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MonthlyLoanCalcFrame().setVisible(true);
            }
        });
    }
